...
contract NFTMarket1 is ERC721URIStorage, Ownable {
  ...
  function listNFT(uint256 tokenID, uint256 price) public {
    require(price > 0, "NFTMarket1: price must be greater than 0");
  ...
  function buyNFT(uint256 tokenID) public payable {
     ...
     require(listing.price > 0, "NFTMarket1: nft not listed for sale");
     require(msg.value == listing.price, "NFTMarket1: incorrect price");
  ...
  function cancelListing(uint256 tokenID) public {
     NFTListing memory listing = _listings[tokenID];
     require(listing.price > 0, "NFTMarket1: nft not listed for sale");
     require(listing.seller == msg.sender, "NFTMarket1: you're not the seller");
     ERC721(address(this)).transferFrom(address(this), msg.sender, tokenID);
     clearListing(tokenID);
     emit NFTTransfer(tokenID, address(this), msg.sender, "", 0);
  }
  ...
  function withdrawFunds() public onlyOwner {
    ...
    require(balance > 0, "NFTMarket1: balance is zero");
