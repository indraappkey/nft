...
//   before(async () => {
//     // Deploy the NFTMarket1 contract
//     const NFTMarket1 = await ethers.getContractFactory("NFTMarket1");
//     nftMarket = await NFTMarket1.deploy();
...
//         "NFTMarket1: price must be greater than 0"
//       );
//     });
...
//       await expect(transaction).to.be.revertedWith(
//         "NFTMarket1: nft not listed for sale"
//       );
//     });
...
//       await expect(transaction).to.be.revertedWith(
//         "NFTMarket1: you're not the seller"
//       );
//     });
